    ...
    with tab7:
        ...
        if len(d6_list) > 0 and len(d4_list) > 0:
            ...
            with c_bx1:
                ...
                st.text_area("Copy 6x4 Cross Pairs:", value=", ".join(cross_6x4), height=140, key="box_6x4")
            
            with c_bx2:
                st.markdown("📦 **खाना 2: केवल 6-अंकों की अपनी क्रॉसिंग (36)**")
                st.text_area("Copy 6-Digit Self Pairs:", value=", ".join(cross_6_self), height=140, key="box_6_self")
                
            with c_bx3:
                st.markdown("📦 **खाना 3: केवल 4-अंकों की अपनी क्रॉसिंग (16)**")
                st.text_area("Copy 4-Digit Self Pairs:", value=", ".join(cross_4_self), height=140, key="box_4_self")
